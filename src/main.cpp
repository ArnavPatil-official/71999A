...
void initialize() {
  ...
  chassis.opcontrol_curve_default_set(0.0, 1);  // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)
...
void opcontrol() {
  ...
  bool descorer_toggle = false;
  bool stage_toggle = true;
